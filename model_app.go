...
type App struct {
	...
	ApnsP8 *string `json:"apns_p8,omitempty"`
...
// GetApnsP8 returns the ApnsP8 field value if set, zero value otherwise.
func (o *App) GetApnsP8() string {
	if o == nil || o.ApnsP8 == nil {
		var ret string
		return ret
	}
	return *o.ApnsP8
...
// SetApnsP8 gets a reference to the given string and assigns it to the ApnsP8 field.
...
func (o App) MarshalJSON() ([]byte, error) {
	...
	if o.ApnsKeyId != nil {
		toSerialize["apns_key_id"] = o.ApnsKeyId
	}
	if o.ApnsTeamId != nil {
		toSerialize["apns_team_id"] = o.ApnsTeamId
	}
	if o.ApnsBundleId != nil {
		toSerialize["apns_bundle_id"] = o.ApnsBundleId
	}
	if o.ApnsP8 != nil {
		toSerialize["apns_p8"] = o.ApnsP8
	}
