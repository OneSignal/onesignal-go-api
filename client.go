...
// APIClient manages communication with the OneSignal API v5.0.1
...
func (c *APIClient) prepareRequest(
    ...
    localVarRequest.Header.Add("OS-Usage-Data", "kind=sdk, sdk-name=onesignal-go, version=5.0.0-beta1")
