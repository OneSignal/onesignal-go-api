...
**ApnsKeyId** | Pointer to **NullableString** | iOS: Required if using p8. Unique identifier for the p8 authentication key. | [optional] 
**ApnsTeamId** | Pointer to **NullableString** | iOS: Required if using p8. Team ID generated by Apple for your developer account. | [optional] 
**ApnsBundleId** | Pointer to **NullableString** | iOS: Required if using p8. Bundle ID for your app in the Apple ecosystem. | [optional] 
**ApnsP8** | Pointer to **NullableString** | iOS: Required if using p8. Base64 encoded p8 key | [optional] 
...
**BasicAuthKey** | Pointer to **NullableString** |  | [optional] [readonly] 
...
`func (o *App) SetApnsBundleIdNil(b bool)`
