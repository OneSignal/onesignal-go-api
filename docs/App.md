...
**ApnsKeyId** | Pointer to **string** | iOS: Required if using p8. Unique identifier for the p8 authentication key. | [optional] 
**ApnsTeamId** | Pointer to **string** | iOS: Required if using p8. Team ID generated by Apple for your developer account. | [optional] 
**ApnsBundleId** | Pointer to **string** | iOS: Required if using p8. Bundle ID for your app in the Apple ecosystem. | [optional] 
**ApnsP8** | Pointer to **string** | iOS: Required if using p8. Base64 encoded p8 key | [optional] 
